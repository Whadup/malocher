...
Malocher is a lightweight python library for running jobs on a cluster where nodes share a common network storage like traditional NFS or mountable cloud storage. We
